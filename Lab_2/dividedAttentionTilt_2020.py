...
#window
mywin = visual.Window([800,600], monitor="testMonitor", units="pix", fullscr=True)
...
for itrial in range (0,ntrials):
    ...
    texttodisplay='Trial ' + repr(itrial+1) + ': Press any key to start' 
    ...
    if instruction[0] not in ('G', 'g'): #if B or N
     ...
     #   print targetletterresponse    
       ...
       # utargetletterresponse=targetletterresponse.upper()
        ...
        feedback='Response: ' + targetletterresponse + '\n Actual: ' + str(targetnumeral)
    ...
    if instruction[0] not in ('N', 'n'): #if B or G ask the location of the grating 
      ...
      #  gloc=repr(whichgrating)            
        feedback= 'Response: ' + gratinglocationresponse + '\n Actual: ' + gloc
